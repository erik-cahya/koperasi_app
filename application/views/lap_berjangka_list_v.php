...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Cetak Data Tabungan Berjangka</h3>
...
<div class="box-body">
<p></p>
	<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Laporan Tabungan Berjangka Periode <?php echo $tgl_periode_txt; ?></p>
	<table  class="table table-bordered">
		<tr class="header_kolom">
			...
			<th class="h_tengah" style="width:10%; vertical-align: middle"> Tanggal <br>Daftar</th>
			...
			<th class="h_tengah" style="width:15%; vertical-align: middle"> Total Terkumpul </th>
	...
	if (!empty($data_berjangka)) {
		foreach ($data_berjangka as $row) {
			...
			if ($row->status == 'Aktif') {
				...
				$status = '<span class="label label-default">Selesai/Cair</span>';
			}

			echo '
				<tr bgcolor='.$warna.'>
						<td class="h_tengah" style="vertical-align:middle">'.$no++.'</td>
						<td class="h_tengah" style="vertical-align:middle"> TRB'.sprintf('%05d', $row->id).'</td>
						...
						<td class="h_kanan" style="vertical-align:middle"> <b>'.number_format($row->total_terkumpul).'</b></td>
...
function clearSearch(){
	window.location.href = '<?php echo site_url("lap_berjangka"); ?>';
}
...
function doSearch() {
	...
	$('#fmCari').attr('action', '<?php echo site_url('lap_berjangka'); ?>');
	$('#fmCari').submit();	
}
...
function cetak () {
    ...
    var url = '<?php echo site_url("lap_berjangka/cetak"); ?>';
