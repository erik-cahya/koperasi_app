	...
	<div class="form-box" id="login-box">
		...
		<form action="" method="post">
			<div class="body bg-gray">
				<?php if($jenis == 'member') { ?>
					<h4><strong><center>Member Login</center> <br> </strong><a href="<?php echo site_url('login'); ?>" class="btn btn-warning btn-block">Login as Admin/Opreator</a></h4>
				<?php } else { ?>
					<h4><strong><center>Admin dan Operator Login</center> <br> </strong><a href="<?php echo site_url('member'); ?>" class="btn btn-warning btn-block">Login as Member</a></h4>
				<?php } ?>
			...
			<div class="footer"> 
		<div align="center">&copy; Copyright <?php echo date('Y'); ?> |  Koperasi Mardiana. </div> 
			</div>
		</form>
	</div>
